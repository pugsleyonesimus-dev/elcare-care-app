...
export default function LaunchpadAdminError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Launchpad Admin Route Error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 text-center">
      ...
      <p className="text-gray-500 mb-8 max-w-sm font-inter">
        We hit an error loading the admin dashboard. This is usually a temporary issue.
      </p>
