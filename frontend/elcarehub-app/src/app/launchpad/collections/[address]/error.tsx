...
export default function CollectionDetailError({
  ...
  useEffect(() => {
    console.error("Collection Detail Route Error:", error);
  }, [error]);

  return (
    <div className="min-h-screen bg-brand-50/20 flex flex-col items-center justify-center p-4 text-center">
      ...
      <p className="text-gray-500 mb-8 max-w-sm font-inter">
        We hit an error loading this collection. This is usually a temporary issue.
      </p>
