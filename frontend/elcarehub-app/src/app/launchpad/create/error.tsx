...
export default function CreateCollectionError({
  ...
  useEffect(() => {
    console.error("Create Collection Route Error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-midnight-950 text-white flex flex-col items-center justify-center p-4 text-center">
      ...
      <p className="text-white/60 mb-10 max-w-md font-inter">
        We encountered an error loading the collection creator. This might be a temporary connection issue.
      </p>
