...
export default function IncomingOffersError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Incoming Offers Route Error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 text-center">
      ...
      <p className="text-gray-500 mb-8 max-w-sm font-inter">
        We hit an error loading your incoming offers. This is usually a temporary issue.
      </p>
